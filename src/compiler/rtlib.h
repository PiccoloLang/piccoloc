...
#define TYPE_FN_PTR fnPtrType 

// TODO: replace all of this with pure llvm, unless absolutely necessary
#define RTLIB_FUNC_X \
    ...
    RTLIB_FUNC(makeFn, TYPE_VAL, 1, false, TYPE_FN_PTR) \
    ...
    RTLIB_FUNC(makeQuotedCall, TYPE_VAL, 6, true, TYPE_VAL, TYPE_STR, TYPE_INT, TYPE_INT, TYPE_INT, TYPE_INT) \
    ...
    RTLIB_FUNC(makeQuotedFn, TYPE_VAL, 2, true, TYPE_VAL, TYPE_INT) \
    \
    RTLIB_FUNC(call, TYPE_VAL, 2, true, TYPE_VAL, TYPE_INT) \
    RTLIB_FUNC(callRtFn, TYPE_VAL, 2, false, TYPE_VOID_PTR, TYPE_VAL_PTR) \
    ...
    RTLIB_FUNC(setCurrRtVar, TYPE_VOID, 1, false, TYPE_VOID_PTR) \
    RTLIB_FUNC(addRtVar, TYPE_VOID, 3, false, TYPE_STR, TYPE_INT, TYPE_VAL_PTR) \
    \
    RTLIB_FUNC(allocateObj, t->objPtrType, 2, false, t->intType, t->intType)
